...
<body class="cbp-spmenu-push">
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST")
    {
       $con = new mysqli("localhost","root","","boxoffice");
		...
		$_Movie_name=["txtmoviename"];
		$_Img_pat=["txtimgpath"];
		$_theater_name=["txttheatername"];
		$_theater_add=["txttheateradd"];
		$_Start_time=["txtstarttime"];
        $_Date=["txtdate"];
        $_Price=["txtprice"];
        $_fk_Screen_id=["txtfkscreenid"];
	...
	<form role="form" method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
								<div class="form-group">
									...
									<input class="form-control" id="register-username"  type="text" name="txtmoviename" placeholder="Enter Movie Name">
								</div>
                <div class="form-group">
		        				 	<label for="register-username"><i class="icon-user"></i> <b>Select Image</b></label>
									<input class="form-control" id="register-username"  type="text" name="txtimgpath" placeholder="Select Image">
								</div>
								<div class="form-group">
							...
							<!--	<div class="form-group">
								...
								<div class="form-group">
									...
									<input class="form-control" id="register-password" type="text" name="txtstarttime" placeholder="Enter Start time">
								</div>
															<div class="form-group">
		        				 	<label for="register-password"><i class="icon-lock"></i> <b>Enter Date</b></label>
									<input class="form-control" id="register-password" type="text" name="txtdate" placeholder="Enter Date">
								</div>
															<div class="form-group">
		        				 	<label for="register-password"><i class="icon-lock"></i> <b>Enter Price</b></label>
									<input class="form-control" id="register-password" type="text" name="txtprice" placeholder="Enter Director Name">
								</div>
                                
                	<div class="form-group">
		        				 	<label for="register-password2"><i class="icon-lock"></i> <b>Enter Screen ID </b></label>
									<input class="form-control" id="register-password2" type="text" name="txtfkscreenid" placeholder="Enter Producer Name ">
								</div>
               				<div class="form-group">
